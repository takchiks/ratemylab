    ...
    <div class="container login-container">
        ...
        <div class="row">
            <div class="col-12 login-form-1 bg-light">
                <form method="get" action="./view_lab_ratings.php" class="col-12 col-lg-8 col-md-10">
                    ...
                    <div class="form-group d-flex justify-content-center row">
                        <input type="submit" name="config_lab" class="btnSubmit col-4 offset-1" value="View" />
